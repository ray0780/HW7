...
int main(void)
{
	...
	pRead = fopen("C:/Users/ray/Desktop/110360206_劉子睿/CH7_Lab2/credit.txt", "r");
	if (NULL == pRead)
	{
		return 0;
	}

	pWrite = fopen("C:/Users/ray/Desktop/110360206_劉子睿/CH7_Lab2/credit_bin.txt", "wb");
	if (NULL == pWrite)
	{
		fclose(pRead);
		return 0;
	...
	printf("\n讀取二進位資料檔案，並格式化輸出如下:\n");
	if ((cfPtr = fopen("C:/Users/ray/Desktop/110360206_劉子睿/CH7_Lab2/credit_bin.txt", "rb")) == NULL)
	{
